...
Ergänzend zu den objektiven Messungen wurde eine subjektive Hörvalidierung durchgeführt. Dabei wurden verschiedene Musiktitel unterschiedlicher Genres auf den fertig montierten DML-Lautsprechern wiedergegeben und hinsichtlich ihrer Klangqualität beurteilt. Die Bewertung erfolgte im direkten Vergleich mit dem in Kapitel 3 verwendeten Referenzlautsprecher.
...
Im Tieftonbereich waren die erwarteten Einschränkungen wahrnehmbar. Bassintensive Musikstücke klangen weniger druckvoll als über den konventionellen Referenzlautsprecher. Durch gezielte Anpassung des Equalizers konnte der Tieftonbereich jedoch merklich verbessert werden, sodass eine für den vorgesehenen Einsatzzweck ausreichende Basswiedergabe erreicht wurde.
