...
\vspace{-2mm}
\begin{itemize}[leftmargin=*, nosep, topsep=0pt, parsep=0pt]
    \item Hohe Abstrahleffizienz
    \item Maximale mechanische Stabilität
    \item Gute Wandintegration möglich
\end{itemize}
\vspace{-2mm}
&
\vspace{-2mm}
\begin{itemize}[leftmargin=*, nosep, topsep=0pt, parsep=0pt]
    \item Unterdrückung der Randmoden
    \item Gestörte Modenverteilung
    \item Tiefton unterdrückt
    \item Erhöhter Konstruktionsaufwand
\end{itemize}
\vspace{-2mm} \\
\hline
\end{tabular}
