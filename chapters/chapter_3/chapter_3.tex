...
Die Abbildung \ref{fig:modellaufbau} zeigt den Modellaufbau der Platte, zu sehen ist die Platte, welche mit einem Netz bespannt ist. In der Studie ist die gewünschte Anzahl der Eigenfrequenzen auf 400 eingestellt und die Berechnung startet bei \SI{0}{\hertz} und endet, wenn 400 Eigenmoden der Platte berechnet wurden. 
...
\begin{figure}[H]
	\centering
	\includegraphics[angle=270,width=0.8\textwidth]{pictures/Eigenmoden_0.7m.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[angle=270,width=0.8\textwidth]{pictures/Eigenmoden_1m.png}
...
\textbf{Abbildung Whileschleife.PNG}
