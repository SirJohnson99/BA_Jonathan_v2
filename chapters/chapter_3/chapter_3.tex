...
Die Abweichungen zwischen simulierten und gemessenen Eigenfrequenzen nehmen mit steigender Frequenz tendenziell zu, was auf mehrere Faktoren zurückzuführen ist. Erstens wurde die Sandwichplatte in der Simulation als monolithische Ersatzplatte modelliert, was die realen Schichteigenschaften nur näherungsweise abbildet. Zweitens wurden die Materialparameter aus dem Datenblatt für KAPA Graph übernommen, da für KAPA Line keine vollständigen Angaben vorlagen. Drittens wurde der Exciter selbst nicht in das FEM-Modell integriert, obwohl dessen Masse und Steifigkeit die lokale Modenstruktur beeinflussen können. Trotz dieser Vereinfachungen liegt die Übereinstimmung im Tiefton- und unteren Mittenbereich im Rahmen von 10--15\,\%, was für eine ingenieurmäßige Auslegung als hinreichend genau anzusehen ist.
...
\begin{itemize}
    \item Im Hochtonbereich oberhalb von 2\,kHz steigt die Modendichte stark an, sodass einzelne Moden nicht mehr separierbar sind. Die Simulation kann hier nur noch statistische Aussagen über die mittlere Modenaktivität liefern.
