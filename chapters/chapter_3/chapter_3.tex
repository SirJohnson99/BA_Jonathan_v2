...
Während passive Weichen das Signal nach dem Verstärker in die verschiedenen Frequenzbereiche trennt, ermöglicht ein DSP die digitale Signalverarbeitung in Echtzeit und eine Variable Trennfrequenz. Ein DSP kann neben der Frequenztrennung auch als Equalizer verwendet werden, was insbesondere bei DML-Systemen von Vorteil sein kann. 
...
Abbildung \ref{fig:frontpanel_labview} zeigt das Frontpanel während der Vermessung der 70 $\times$ 44\,cm Platte mit den simulierten Exciterpositionen. Im Graphen oben links ist das Anregungssignal in Form eines weißen Rauschens zu sehen, oben rechts werden Mikrofon- und Referenzsignal dargestellt. In der Mitte sind die FRF-Übertragungsfunktion und die zugehörige Kohärenz aufgetragen, im unteren Bereich der Schalldruckpegel über der Frequenz.
