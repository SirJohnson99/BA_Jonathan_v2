...
Bei der Eigenfrequenzanalyse wurden zwei KAPA Line Platten mit den Größen \SI{1}{\meter} $\times$ \SI{0,7}{\meter} und \SI{0,7}{\meter} $\times$ \SI{0,44}{\meter} mit der Stärke \SI{15}{\milli\meter} auf deren Eigenfrequenzen untersucht. Dabei wurden die Größendaten und die Eigenschaften des Materials welche dem Datenblatt im anhang C entnommen werden können, im Modelbuilder eingegeben. Die Platte wurde in der Simulation als eine monolithische Platte angenommen und nicht als Sandwichbauweise. Für diesen Aufbau wurde sich aufgrund von geringerer Komplexität des Modells und fehlender Materialeigenschaften der einzelnen Schichten entschieden. Da im KAPA Line Datenblatt Anhang C nur die Materialeigenschaften als Sandwichbauweise und nicht der einzelnen Materialien, Deckschicht und Kern angegeben wurden. Anschließend wurde eine Eigenfrequenzstudie angelegt, bei der die Platten angeregt werden von 0 Hz bis 400 Eigenmoden der Platten berechnet wurden. Die Anzahl der Eigenmoden wurde gewählt, da diese für beide Platten die 1.000 Hz überschritten haben und die Modendichte mit zunehmender Frequenz zunimmt \cite{Cremer1996}. Im Konzeptentwurf wurde sich für eine freihängende Lagerung entschieden, aus diesem Grund wurde diese in der Simulation ohne Lagerung erstellt.
...
Die berechneten Eigenmoden der Platten bilden Muster, welche die Verschiebung der Platte bei den Eigenfrequenzen zeigen. Die Abbildungen \ref{fig:eigenmoden_07m} \ref{fig:eigenmoden_1m} zeigen die Muster der simulierten Eigenmoden im Bereich der Frequenzen bei \SI{50}{\hertz}, \SI{150}{\hertz}, \SI{300}{\hertz}, \SI{500}{\hertz}, \SI{800}{\hertz} und \SI{1000}{\hertz} an.  
...
\clearpage
 ...
 In dieser Arbeit wurden zur Untersuchung der akustischen Eigenschaften des DML zwei Versuchsaufbauten durchgeführt.
 Um die durchgeführten Messungen vergleichen zu können, wurden während des gesamten Versuchsaufbaus die Einstellungen des Equalizers und des Audioverstärkers nicht geändert. Der Gain des Equalizers wurde auf 5 und die Lautstärke der  Stereoanlage auf 10 eingestellt, der Equalizer hat während der Messungen keine Signalanpassung vorgenommen. Die Temperatur sowie die Luftfeuchtigkeit waren während der Messungen gleich bei 21 Grad C und 25 \% Luftfeuchtigkeit.
