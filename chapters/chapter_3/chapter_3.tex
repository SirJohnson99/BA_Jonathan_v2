...
\clearpage
 ...
 In dieser Arbeit wurden zu untersuchung der Akustischen eigenschaften des DML zwei versuchsaufbauten durchgeführt.
 Um die durchgeführten Messungen vergleichen zu können, wurden während des gesamten Versuchsaufbaus die Einstellungen des Equalizers und des Audioverstärkers nicht geändert. Der Gain des Equalizers wurde auf 5 und die Lautstärke der  Stereoanlage auf 10 eingestellt, der Equalizer hat während der Messungen keine Signalanpassung vorgenommen. Die Temperatur sowie die Luftfeuchtigkeit waren währen der Messungen geich bei 21 Grad C und 25 \% Luftfeuchtigkeit.
...
Die Ergebnissse der Simulation sowie der Versuchsaufbauten zeigen trotz vereinfachterannahmen ein Positives ergebnis. Dabei ist zu erkennen das die Simulierten Positionen Trotz Monolitischer Simulation eine höheren Schalldruckpegel erreichen als die vom Herteller verwendeten universal Positionen. Dennoch sind einige aspekte zu beachten welche die ergebnisse Beeinflusst haben können. 
...
Obwohl der Freifeldraum reflexionsarm ausgelegt ist, befanden sich während der Messung Gegenstände im Raum -- unter anderem Stativkonstruktionen, Messgeräte und Gitterroste am Boden und ein Verbrennungsmotor auf einem Gestell wie in Abbildung~\ref{fig:messaufbau_freifeldraum} zu erkennen ist. Diese können insbesondere im Hochtonbereich als reflektierende Flächen wirken und das gemessene Schallfeld verfälschen. 
 
Zudem kann durch eine Messunsicherheit des DAQ sowie des verwendeten Messsmikrofons eine verfälschung des Graphen entstehen. Unterberücksichtigung dieser möglichen Messungenauigkeiten kann dennoch davon ausgegangen werden das die SPL Messung aussagekräftig ist da diese die Klassischen Charakteristiken von DML Lautsprechern aufzeigt. 
