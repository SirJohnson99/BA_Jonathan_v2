...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pictures/Eigenmoden_0.7m.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pictures/Eigenmoden_1m.png}
...
\begin{figure}[H]
	...
	\caption{Konsolenausgabe des Python-Skripts mit den Top-10 Exciter-Positionspaaren für die 100 $\times$ 70\,cm Platte. Die optimalen Koordinaten werden sowohl relativ zur Plattenmitte als auch zur Plattenecke angegeben.}
	\label{fig:skript_100x70}
\end{figure}

Abbildung \ref{fig:skript_100x70} zeigt die Konsolenausgabe des Auswertungsskripts für die große Platte. Die ermittelten optimalen Positionen liegen bei Exciter~1: $x = 50{,}0$\,mm, $z = 382{,}8$\,mm und Exciter~2: $x = 875{,}0$\,mm, $z = 65{,}6$\,mm (relativ zur linken unteren Ecke).

\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{pictures/Skript_ergebnis_100x70.png}
	\caption{Visualisierung der Skript-Ergebnisse für die 100 $\times$ 70\,cm Platte. Links: Score-Heatmap für Exciter~2 bei fixierter Position von Exciter~1. Rechts: Plattenansicht mit markierten Exciter-Positionen und mittlerer Modenaktivität.}
	\label{fig:skript_ergebnis_100x70}
\end{figure}

In Abbildung \ref{fig:skript_ergebnis_100x70} ist links die Score-Heatmap dargestellt, wobei helle Bereiche (hoher Score) günstige Positionen für Exciter~2 anzeigen. Die dunklen Bereiche kennzeichnen Knotenlinien der Eigenmoden, an denen eine Anregung vermieden werden sollte. Rechts ist die mittlere Modenaktivität über alle betrachteten Frequenzen dargestellt, wobei dunkle Bereiche eine geringe Verschiebung und somit geeignete Exciter-Positionen markieren.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pictures/Skript_70x44.png}
	\caption{Konsolenausgabe des Python-Skripts mit den Top-10 Exciter-Positionspaaren für die 70 $\times$ 44\,cm Platte.}
...
\begin{figure}[H]
	...
	\caption{Visualisierung der Skript-Ergebnisse für die 70 $\times$ 44\,cm Platte. Links: Score-Heatmap für Exciter~2. Rechts: Plattenansicht mit optimalen Exciter-Positionen und Modenaktivität.}
