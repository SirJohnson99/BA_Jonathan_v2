...
\vspace{0.2cm}
\scriptsize
\textbf{Quellen:} \cite{Bai2001}, \cite{Cremer1996}, \cite{Moeser2010}.
\end{table}
...
Der Modellaufbau der Platte in COMSOL Multiphysics ist in Anhang E dargestellt und zeigt die Platte, welche mit einem Netz bespannt ist. In der Studie ist die gewünschte Anzahl der Eigenfrequenzen auf 400 eingestellt und die Berechnung startet bei \SI{0}{\hertz} und endet, wenn 400 Eigenmoden der Platte berechnet wurden. 
...
\begin{figure}[H]
	...
	\caption{Eigenmoden der KAPA Line Platte (70 $\times$ 44\,cm)}
...
\begin{itemize}
    \item Erzeugung und Wiedergabe eines Testsignals 
    ...
    \item Speicherung der Messwerte als verarbeitbare Datei.
\end{itemize}
...
Im Freifeldraum befanden sich während der Messung zudem Stativkonstruktionen, Messgeräte, Gitterroste am Boden sowie ein Verbrennungsmotor auf einem Gestell, wie in Abbildung~\ref{fig:messaufbau_freifeldraum} zu erkennen ist. Diese können im Hochtonbereich als reflektierende Flächen wirken und das Messergebniss verfälschen.
