...
Die Verwendung eines einzelnen Exciters pro Platte ist die einfachste Umsetzung. Die Impedanz des Systems entspricht der des Exciters von \SI{4}{\ohm} \cite{DaytonAudio2024}, was dem Anhang A zu entnehmen ist. Die verwendete Stereoanlage kann Lautsprecher von \SIrange{4}{16}{\ohm} versorgen, siehe Anhang B. Dennoch sollte berücksichtigt werden, dass die Exciter bei voller Leistung auf Dauer beschädigt werden können. Zudem kann die Platzierung des Exciters ungünstig für die Modenanregung sein. 
...
Bei der Verkabelung des Systems gibt es die Entscheidung zwischen Reihen- und Parallelschaltung. Bei der Reihenschaltung der Exciter addiert sich die Impedanz, was bei zwei Excitern zu einer Verdoppelung der Gesamtimpedanz führt. Eine Verdoppelung der Gesamtimpedanz auf \SI{8}{\ohm} kann die Langlebigkeit der Exciter erhöhen, da diese bei voller Last einer geringeren thermischen Belastung ausgesetzt sind.
...
Sim Ergebniss Abbildung 100x70 
 
Sim Ergebniss Abbildung 70x44 
