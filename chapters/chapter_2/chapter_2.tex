...
\begin{figure}[H]
	...
	\caption[Abstrahlgrad einer gedämpften Platte in Abhängigkeit von der Frequenz]{Abstrahlgrad einer gedämpften, unendlich ausgedehnten Aluminiumplatte mit \SI{2}{\milli\meter} Stärke und Koinzidenz Frequenz $f_c = \SI{5928}{\hertz}$ in Abhängigkeit von der Frequenz für die Verlustfaktoren $\eta = 1\,\%$, $2\,\%$ und $4\,\%$ \cite{Kou2015}.}
